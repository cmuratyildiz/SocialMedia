        ...
        <div class="col-lg-3 col-12">
            <div class="box-content bordered primary margin-bottom-20">
                <div class="profile-avatar">
                    <img src="{{asset('avatar/admin-avatar/'.$admin->image.'')}}" alt="">
                    ...
                    <h3><strong>{{$admin->name}}</strong></h3>
                ...
                <table class="table table-hover no-margin">
                    ...
                    <tr>
                        <td>Durumu</td>
                        @if($admin->status == 1)
                        <td><span class="notice notice-danger">Aktif</span></td>
                            @else
                            <td><span class="notice notice-danger">Pasif</span></td>
                            @endif
                    </tr>
                    <tr>
                        <td>User Rating</td>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="box-content card">
                        <h4 class="box-title"><i class="fa fa-user ico"></i>Hakkımda</h4>
                        <!-- /.box-title -->
                        ...
                        <div class="card-content">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-5"><label>Adınız:</label></div>
                                        <!-- /.col-5 -->
                                        <div class="col-7">{{$admin->name}}</div>
                                        <!-- /.col-7 -->
                                    </div>
                                    <!-- /.row -->
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        <div class="col-5"><label>Soyadınız:</label></div>
                                        <!-- /.col-5 -->
                                        <div class="col-7">{{$admin->lastname}}</div>
                                        <!-- /.col-7 -->
                                    </div>
                                    <!-- /.row -->
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <!-- /.col-5 -->
                                        <div class="col-7"><a href="" class="__cf_email__">{{$admin->email}}</a></div>
                                        <!-- /.col-7 -->
                                    </div>
                                    <!-- /.row -->
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <!-- /.col-5 -->
                                        <div class="col-7"><a href="{{route('home')}}">universtagram.com</a></div>
                                        <!-- /.col-7 -->
                                    </div>
                                    <!-- /.row -->
                                </div>

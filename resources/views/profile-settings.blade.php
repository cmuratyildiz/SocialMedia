                    ...
                    <div class="col-lg-3">
                        <div class="acc-leftbar">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-acc-tab" data-toggle="tab" href="#nav-acc" role="tab" aria-controls="nav-acc" aria-selected="true"><i class="la la-cogs"></i>Hesap Ayarları</a>
                                <a class="nav-item nav-link" id="nav-status-tab" data-toggle="tab" href="#nav-status" role="tab" aria-controls="nav-status" aria-selected="false"><i class="fa fa-line-chart"></i>Profil Ayarları</a>
                                <a class="nav-item nav-link" id="nav-password-tab" data-toggle="tab" href="#nav-password" role="tab" aria-controls="nav-password" aria-selected="false"><i class="fa fa-lock"></i>Şifre Değişikliği</a>
                                ...
                                <a class="nav-item nav-link" id="nav-notification-tab" data-toggle="tab" href="#nav-notification" role="tab" aria-controls="nav-notification" aria-selected="false"><i class="fa fa-flash"></i>Bildirimler</a>
                                <a class="nav-item nav-link" id="nav-privcy-tab" data-toggle="tab" href="#privcy" role="tab" aria-controls="privacy" aria-selected="false"><i class="fa fa-group"></i>İstekler</a>
                                <a class="nav-item nav-link" id="security" data-toggle="tab" href="#security-login" role="tab" aria-controls="security-login" aria-selected="false"><i class="fa fa-user-secret"></i>Güvenlik ve Giriş</a>
                                ...
                                <a class="nav-item nav-link" id="nav-deactivate-tab" data-toggle="tab" href="#nav-deactivate" role="tab" aria-controls="nav-deactivate" aria-selected="false"><i class="fa fa-random"></i>Hesabı Sil</a>
                            </div>
                        </div><!--acc-leftbar end-->
                    </div>
                    <div class="col-lg-9">
                        <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="acc-setting">
                                    ...
                                    <form>
                                        ...
                                        <div class="save-stngs">
                                            <ul>
                                                <li><button type="submit">Ayarları Kaydet</button></li>
                            ...
                            <div class="tab-pane fade" id="nav-status" role="tabpanel" aria-labelledby="nav-status-tab">
                                <div class="acc-setting">
                                    ...
                                    <div class="profile-bx-details">
                                        <div class="row">
                                            <form name="profilsetting" action="{{ route('profile.account') }}" method="post">
                                                @csrf
                                                <div class="cp-field">
                                                    <h5>Nickname</h5>
                                                    <div class="cpp-fiel">
                                                        <input type="text" name="nickname" value="{{$uses->nickname}}">
                                                ...
                                                <div class="cp-field">
                                                    <h5>Email</h5>
                                                    <div class="cpp-fiel">
                                                        <input type="text" name="email" value="{{$uses->email}}">
                                                        <i class="fa fa-lock"></i>
                                                    </div>
                                                </div>
                                                <div class="cp-field">
                                                    <h5>Adınız</h5>
                                                    <div class="cpp-fiel">
                                                        <input type="text" name="name" value="{{$uses->name}}">
                                                        <i class="fa fa-lock"></i>
                                                    </div>
                                                </div>
                                                <div class="cp-field">
                                                    <h5>Soyadınız</h5>
                                                    <div class="cpp-fiel">
                                                        <input type="text" name="lastname" value="{{$uses->lastname}}">
                                                        <i class="fa fa-lock"></i>
                                                    </div>
                                                </div>
                                                <div class="cp-field">
                                                    <h5>Telefon</h5>
                                                    <div class="cpp-fiel">
                                                        <input type="text" name="telephone" value="{{$uses->telephone}}">
                                                        <i class="fa fa-lock"></i>
                                                    </div>
                                                </div>
                                                <div class="cp-field">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <input type="file" name="select_file" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                            ...
                            <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab">
                                <div class="acc-setting">
                                    ...
                                    <form name="resetpassword" action="{{route('reset.password')}}" method="post">
                                        @csrf
                                        <div class="cp-field">
                                            <h5>Eski Şifreniz</h5>
                                            <div class="cpp-fiel">
                                                <input type="password" name="oldpass" placeholder="Eski Şifreniz">
                                                <i class="fa fa-lock"></i>
                                            </div>
                                        </div>
                                        <div class="cp-field">
                                            <h5>Yeni Şifreniz</h5>
                                            <div class="cpp-fiel">
                                                <input type="password" name="newpass" placeholder="Yeni Şifreniz">
                                                <i class="fa fa-lock"></i>
                                            </div>
                                        </div>
                                        <div class="cp-field">
                                            <h5>Tekrar yeni şifre</h5>
                                            <div class="cpp-fiel">
                                                <input type="password" name="repeatpass" placeholder="Tekrar yeni şifre">
                                                <i class="fa fa-lock"></i>
                                            </div>
                                        </div>
                                        <div class="cp-field">
                            ...
                            <div class="tab-pane fade" id="nav-deactivate" role="tabpanel" aria-labelledby="nav-deactivate-tab">
                                <div class="acc-setting">
                                    <h3>Hesabı Dondur</h3>
                                    <form name="deactiveaccount" action="{{route('deactive.account')}}" method="post">
                                        @csrf
                                        <div class="cp-field">
                                            <h5>Email</h5>
                                            <div class="cpp-fiel">
                                        ...
                                        <div class="cp-field">
                                            <h5>Şifreniz</h5>
                                            <div class="cpp-fiel">
                                                <input type="password" value="{{Auth::user()->password}}" name="password"  placeholder="Şifreniz">
                                                <i class="fa fa-lock"></i>
                                            </div>
                                        </div>
                                        <div class="cp-field">
                                        ...
                                        <div class="save-stngs pd3">
                                            <ul>
                                                <li><button type="submit">Hesabı dondur</button></li>
                                                <li><button type="submit">Restore Setting</button></li>
                                            </ul>
                                        </div><!--save-stngs end-->
                                    </form>

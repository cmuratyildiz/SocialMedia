$(window).on("load", function() {
    ...
    $(".post_project3").on("click", function(){
        $(".post-popup3.pst-pj3").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project3 > a").on("click", function(){
        $(".post-popup3.pst-pj3").removeClass("active");
    ...
    //  ============= POST PROJECT POPUP FUNCTION GERÇEK FONKSİYON=========
    ...
    //  ============= POST JOB POPUP FUNCTION  GERÇEK FONKSİYON=========
    ...
    //  ============= POST MESSAGE JOB POPUP FUNCTION ========= UPDATEE

    $(".post-jb2").on("click", function(){
        $(".post-popup2.job_post2").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project2 > a").on("click", function(){
        $(".post-popup2.job_post2").removeClass("active");
        $(".wrapper").removeClass("overlay");
        return false;
    });
